...
//zahnstange_und_rad (modul=2, laenge_stange, zahnzahl_rad, hoehe_stange, bohrung_rad, breite, eingriffswinkel=20, schraegungswinkel=0, zusammen_gebaut=true, optimiert=true)
...
// zahnstange(modul=1, laenge=30, hoehe=5, breite=5, eingriffswinkel=20, schraegungswinkel=20);
 ...
 stirnrad (modul=0.5, zahnzahl=30, breite=5, bohrung=0, eingriffswinkel=20, schraegungswinkel=0, optimiert=false);
...
// hohlrad (modul=2.3, zahnzahl=10, breite=3, randbreite=3, eingriffswinkel=0, schraegungswinkel=0);
